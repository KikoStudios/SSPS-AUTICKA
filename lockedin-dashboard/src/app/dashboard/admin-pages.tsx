  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '10px' }}>
        <h1 style={{ fontSize: '24px', margin: 0, color: '#2c3e50', fontFamily: 'JetBrains Mono, monospace' }}>
          ADMIN DASHBOARD
        </h1>
        <div style={{ display: 'flex', gap: '10px', backgroundColor: '#ecf0f1', padding: '5px', borderRadius: '10px' }}>
          <button
            onClick={() => setActiveTab('users')}
            style={{
              padding: '8px 16px',
              backgroundColor: activeTab === 'users' ? '#2c3e50' : 'transparent',
              color: activeTab === 'users' ? '#ffffff' : '#7f8c8d',
              border: 'none',
              borderRadius: '8px',
              cursor: 'pointer',
              fontWeight: 'bold',
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: activeTab === 'api-keys' ? '#2c3e50' : 'transparent',
              color: activeTab === 'api-keys' ? '#ffffff' : '#7f8c8d',
              border: 'none',
              borderRadius: '8px',
              cursor: 'pointer',
              fontWeight: 'bold',
      ...
      {activeTab === 'api-keys' ? (
        <div style={{ flex: 1, backgroundColor: '#0F2044', borderRadius: '20px', padding: '25px', overflowY: 'auto' }}>
          <ApiKeysManagement />
        </div>
      ) : (
        <div style={{ display: 'flex', gap: '20px', flex: 1, height: '100%', overflow: 'hidden' }}>
